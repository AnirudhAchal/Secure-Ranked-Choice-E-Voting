  ...
  return (
    <div>
        <div className="container">
          ...
          <hr />
          <div className="row">{currentElections.map(election => <Elections election={election} />)}</div>
        </div>
        <hr />
        <div className="container">
          <h3 className="my-2 d-flex justify-content-center">
          ...
          <hr />
          <div className="row">{upcomingElections.map(election => <Elections election={election} />)}</div>
        </div>
        <hr />
        <div className="container">
          <h3 className="my-2 d-flex justify-content-center">
          ...
          <hr />
          <div className="row">{pastElections.map(election => <Elections election={election} />)}</div>
        </div>
    </div>
  );
