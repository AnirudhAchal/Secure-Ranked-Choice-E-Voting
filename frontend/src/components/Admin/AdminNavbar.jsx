                    ...
                    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <ul className="navbar-nav mr-auto">
                            <li className="nav-item active">
                                <button className="btn btn-light my-2 my-sm-0" onClick={handleElection}>Create Election</button>
                            </li>
                            <li class="nav-item">
                                <button className="btn btn-light my-2 my-sm-0" onClick={handleRequests}>Candidates Requests</button>
                            </li>
                        </ul>
                    </div>
